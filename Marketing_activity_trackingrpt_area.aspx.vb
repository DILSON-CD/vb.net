...
Partial Class Marketing_activity_trackingrpt_area
    ...
    Dim fr_dt, to_dt, zone_id, region, regid, zoneid, area_id As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        fr_dt = str(0)
        to_dt = str(1)
        area_id = oh.ExecuteDataSet("select b.area_id from branch_dtl_new b where b.BRANCH_ID=" & brid & "").Tables(0).Rows(0)(0)
    ...
    Sub FillReportHeader()
        ...
        tc1.Text = "<font size=4><b> Marketing activity status Area wise Report</font></b>"
    ...
    Sub FillColumnHeader()
        ...
        tc1.Text = "<font size=2><b>Area Name</font></b>"
        tc2.Text = "<font size=2><b>Branch name</font></b>"
        tc3.Text = "<font size=2><b>Branch ID</font></b>"
        tc4.Text = "<font size=2><b>Activity ID</font></b>"
        tc5.Text = "<font size=2><b>PO ID</font></b>"
        tc6.Text = "<font size=2><b>Description</font></b>"
        tc7.Text = "<font size=2><b>Status</font></b>"
        tc8.Text = "<font size=2><b>TotalAmount</font></b>"
        tc9.Text = "<font size=2><b>Enter Date</font></b>"
        tc10.Text = "<font size=2><b>Enter BY</font></b>"
        tc11.Text = "<font size=2><b>Approved BY</font></b>"
        tc12.Text = "<font size=2><b>Image uploaded status</font></b>"
        ' tc1.HorizontalAlign = HorizontalAlign.Center
