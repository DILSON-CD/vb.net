...
Partial Class Marketing_activity_tracking_rpt
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim sql, sql1, fnm, br_id, zone As String
    Dim dt, dt1 As New DataTable
    Dim dr As DataRow
    Dim tbl As New Table
    Dim fr_dt, to_dt, zone_id As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        dt_id = Me.Request.QueryString("dt_id")
    ...
    Sub FillReportHeader()
        ...
        tc1.ColumnSpan = 70
        tc1.Text = "<font size=4><b>Marketing Activity status report</font></b>"
        tc1.HorizontalAlign = HorizontalAlign.Center
        tc1.BackColor = Drawing.Color.Ivory
    ...
    Sub FillColumnHeader()
        ...
        tc1.Text = "<font size=2><b>FZM</font></b>"
        tc2.Text = "<font size=2><b>Region Name</font></b>"
        tc3.Text = "<font size=2><b>Area Name</font></b>"
        tc4.Text = "<font size=2><b>Branch name</font></b>"
        tc5.Text = "<font size=2><b>Branch ID</font></b>"
        tc6.Text = "<font size=2><b>Activity ID</font></b>"
        tc7.Text = "<font size=2><b>PO ID</font></b>"
        tc8.Text = "<font size=2><b>Description</font></b>"
        tc9.Text = "<font size=2><b>Status</font></b>"
        tc10.Text = "<font size=2><b>TotalAmount</font></b>"
        tc11.Text = "<font size=2><b>Enter Date</font></b>"
        tc12.Text = "<font size=2><b>EnteR BY</font></b>"
        tc13.Text = "<font size=2><b>Approved BY</font></b>"
        tc14.Text = "<font size=2><b>Image uploaded status</font></b>"
        ...
        tr4.BackColor = Drawing.Color.DarkSalmon
    ...
    Sub FillColumnField()
        If post = -36 Then
            dt1 = oh.ExecuteDataSet("select ff.fzm from tbl_fzm_master ff where   ff.fzm_empcode=" & usrID & "   and ff.fzm = (select distinct f.fzm from tbl_fzm_master f, branch_dtl_new q where f.region_id=q.reg_id and  q.branch_id =" & brid & " )").Tables(0)
            Dim fzm As String = dt1.Rows(0)(0).ToString()
            sql = "select f.fzm,d.reg_name,d.area_name,d.BRANCH_NAME,d.BRANCH_ID, a.actvty_id, b.po_id, s.description, tt.description status, b.total_amount, to_char(a.enter_date), a.enter_by, b.approved_by, case when m.status in(1,2) then 'YES' else 'NO' end from mana0809.tbl_marketing_activity_new a, mana0809.branch_dtl_new d, mana0809.tbl_fzm_master f, mana0809.STATUS_MASTER s, mana0809.TBL_PURCHASE_STATUS_MASTER tt, mana0809.TBL_PO_MASTER b, TBL_MARKETING_PHOTO_STATUS m where a.actvty_id = b.act_id and a.brid = d.BRANCH_ID and d.reg_id = f.region_id and a.activity = s.status_id and b.status_id = tt.status_id and s.module_id = 535 and tt.module_id = 4 and tt.option_id = 1 and s.option_id = 1 and m.actvty_id=a.actvty_id and f.fzm='" & fzm & "' and b.po_date between '" & fr_dt & "' and '" & to_dt & "'"


        ElseIf post = 0 Then
            ' sql = "select f.fzm,d.reg_name,d.area_name,d.BRANCH_NAME,d.BRANCH_ID,a.actvty_id, b.po_id, s.description, tt.description status, b.total_amount, to_char(a.enter_date), a.enter_by, b.approved_by, case when m.m_photo is null then 'No' else 'Yes' end from mana0809.tbl_marketing_activity_new a, mana0809.branch_dtl_new d, mana0809.tbl_fzm_master f, mana0809.STATUS_MASTER s, mana0809.TBL_PURCHASE_STATUS_MASTER tt, mana0809.TBL_PO_MASTER b, dms.marketing_photo_upload m where a.actvty_id = b.act_id and a.brid = d.BRANCH_ID and d.reg_id = f.region_id and a.activity = s.status_id and b.status_id = tt.status_id and s.module_id = 535 and tt.module_id = 4 and tt.option_id = 1 and s.option_id = 1 and m.activity_id=a.actvty_id and b.po_date between '" & fr_dt & "' and '" & to_dt & "'"
            sql = "select f.fzm, d.reg_name, d.area_name, d.BRANCH_NAME, d.BRANCH_ID, a.actvty_id, b.po_id, s.description, tt.description status, b.total_amount, to_char(a.enter_date), a.enter_by, b.approved_by, case when m.status in(1, 2) then 'YES' else 'NO' end from mana0809.tbl_marketing_activity_new a, mana0809.branch_dtl_new d, mana0809.tbl_fzm_master f, mana0809.STATUS_MASTER s, mana0809.TBL_PURCHASE_STATUS_MASTER tt, mana0809.TBL_PO_MASTER b, TBL_MARKETING_PHOTO_STATUS m where a.actvty_id = b.act_id and a.brid = d.BRANCH_ID and d.reg_id = f.region_id and a.activity = s.status_id and b.status_id = tt.status_id and s.module_id = 535 and tt.module_id = 4 and tt.option_id = 1 and s.option_id = 1 and m.actvty_id = a.actvty_id and b.po_date between '" & fr_dt & "' and '" & to_dt & "'"
        End If
        ...
        For Each dr In dt.Rows
            ...
            tc51.BackColor = Drawing.Color.AliceBlue
            tc51.ForeColor = Drawing.Color.Indigo
            tc52.BackColor = Drawing.Color.AliceBlue
            tc52.ForeColor = Drawing.Color.Indigo
            tc53.BackColor = Drawing.Color.AliceBlue
            tc53.ForeColor = Drawing.Color.Indigo
            tc54.BackColor = Drawing.Color.AliceBlue
            tc54.ForeColor = Drawing.Color.Indigo
            tc55.BackColor = Drawing.Color.AliceBlue
            tc55.ForeColor = Drawing.Color.Indigo
            tc56.BackColor = Drawing.Color.AliceBlue
            tc56.ForeColor = Drawing.Color.Indigo
            tc57.BackColor = Drawing.Color.AliceBlue
            tc57.ForeColor = Drawing.Color.Indigo
            tc58.BackColor = Drawing.Color.AliceBlue
            tc58.ForeColor = Drawing.Color.Indigo
            tc59.BackColor = Drawing.Color.AliceBlue
            tc59.ForeColor = Drawing.Color.Indigo
            tc510.BackColor = Drawing.Color.AliceBlue
            tc510.ForeColor = Drawing.Color.Indigo
            tc511.BackColor = Drawing.Color.AliceBlue
            tc511.ForeColor = Drawing.Color.Indigo
            tc512.BackColor = Drawing.Color.AliceBlue
            tc512.ForeColor = Drawing.Color.Indigo
            tc513.BackColor = Drawing.Color.AliceBlue
            tc513.ForeColor = Drawing.Color.Indigo
            tc514.BackColor = Drawing.Color.AliceBlue
            tc514.ForeColor = Drawing.Color.Indigo
        ...
        tr6.BackColor = Drawing.Color.Ivory
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        cl_script1.Append("window.open('meeting_schedule_dtselect.aspx','_self');")
