<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SMA_Areawise.aspx.vb" Inherits="Pledge_SMA_classification_SMA_Areawise" %>
...
<head id="Head1" runat="server">
    <title>Untitled Page</title>
     <script language="javascript" type="text/javascript">
         ...
         function GetBranchwiseSMA(Area_id,fdt,tdt) {
             window.open('SMA_Branchwise.aspx?Area_id=' + Area_id + '&fdt=' + fdt + '&tdt=' + tdt + '', '_self');
         }
</script>
</head>
<body>
