...
Partial Class Pledge_SMA_classification_SMA_Regwise
    ...
    Sub FillReportHeader()
        ...
        tc31.Text = "<font color='#663366' size=2><b>REGIONWISE SMA REPORT AS ON  " & fdt & "</font></b>"
    ...
    Sub FillColumnHeader()
        ...
        tc51.Text = "<font size=2><b>REGION</font></b>"
    ...
    Sub FillColumnField()
        ...
        If fdt = tdt Then
            sql = "select b.reg_name, round(sum(S.COL_GL_WT) / 1000, 2) GL_WEIGHT, sum(s.col_total_ln_cnt) PLEDGE_COUNT, round(sum(s.col_total_ln_bal) / 10000000, 2) PLEDGE_AMOUNT, sum(s.col_nodue_ln_cnt) NO_DUE_COUNT, round(sum(s.col_nodue_ln_bal) / 10000000, 2) NO_DUE_AMOUNT, round((sum(s.col_nodue_ln_bal) / 10000000) /(sum(s.col_total_ln_bal) / 10000000) * 100, 2) NO_DUE_PERCENTAGE, sum(nvl(s.col_sma0_ln_cnt, 0) + nvl(s.col_sma1_ln_cnt, 0) + nvl(s.col_sma2_ln_cnt, 0) + nvl(s.col_sma3_ln_cnt, 0)) DUES_COUNT, round(sum(nvl(s.col_sma0_ln_bal / 10000000, 0) + nvl(s.col_sma1_ln_bal / 10000000, 0) + nvl(s.col_sma2_ln_bal / 10000000, 0) + nvl(s.col_sma3_ln_bal / 10000000, 0)), 2) DUES_AMOUNT, round((sum(nvl(s.col_sma0_ln_bal / 10000000, 0) + nvl(s.col_sma1_ln_bal / 10000000, 0) + nvl(s.col_sma2_ln_bal / 10000000, 0) + nvl(s.col_sma3_ln_bal / 10000000, 0))) / (sum(s.col_total_ln_bal) / 10000000) * 100, 2) DUES_PERCENTAGE, sum(s.col_sma0_ln_cnt) SMA0_COUNT, round(sum(s.col_sma0_ln_bal) / 10000000, 2) SMA0_AMOUNT, sum(s.col_sma1_ln_cnt) SMA1_COUNT, round(sum(s.col_sma1_ln_bal) / 10000000, 2) SMA1_AMOUNT, sum(s.col_sma2_ln_cnt) SMA2_COUNT, round(sum(s.col_sma2_ln_bal) / 10000000, 2) SMA2_AMOUNT, sum(s.col_sma3_ln_cnt) SMA3_COUNT, round(sum(s.col_sma3_ln_bal) / 10000000, 2) SMA3_AMOUNT, round((sum(s.col_sma3_ln_bal) / 10000000) / (sum(s.col_total_ln_bal) / 10000000) * 100, 2) NPA_PERCENTAGE, b.reg_id,nvl(sum(s.col_nonnpa_cnt),0) NONNPA_COUNT, nvl(round(sum(s.col_nonnpa_bal) / 10000000, 2),0) NONNPA_BALANCE,round((sum(s.col_sma3_ln_bal) / 10000000) + nvl(sum(s.col_nonnpa_bal) / 10000000,0),2) TOTAL,round((nvl((sum(s.col_sma3_ln_bal) / 10000000),0) + nvl(sum(s.col_nonnpa_bal) / 10000000,0))/(sum(s.col_total_ln_bal) / 10000000) * 100,2) TOTAL_PERCENTAGE from tbl_sma_classification_branch_dtl s,branch_dtl_new b,tbl_fzm_master f where s.col_brid=b.BRANCH_ID and b.reg_id=f.region_id and f.fzm_id=" & zone_id & " group by b.reg_name,b.reg_id order by b.reg_name"
            dt = oh.ExecuteDataSet(sql).Tables(0)

        Else
            sql = "select b.reg_name, round(sum(S.COL_GL_WT) / 1000, 2) GL_WEIGHT, sum(s.col_total_ln_cnt) PLEDGE_COUNT, round(sum(s.col_total_ln_bal) / 10000000, 2) PLEDGE_AMOUNT, sum(s.col_nodue_ln_cnt) NO_DUE_COUNT, round(sum(s.col_nodue_ln_bal) / 10000000, 2) NO_DUE_AMOUNT, round((sum(s.col_nodue_ln_bal) / 10000000) /(sum(s.col_total_ln_bal) / 10000000) * 100, 2) NO_DUE_PERCENTAGE, sum(nvl(s.col_sma0_ln_cnt, 0) + nvl(s.col_sma1_ln_cnt, 0) + nvl(s.col_sma2_ln_cnt, 0) + nvl(s.col_sma3_ln_cnt, 0)) DUES_COUNT, round(sum(nvl(s.col_sma0_ln_bal / 10000000, 0) + nvl(s.col_sma1_ln_bal / 10000000, 0) + nvl(s.col_sma2_ln_bal / 10000000, 0) + nvl(s.col_sma3_ln_bal / 10000000, 0)), 2) DUES_AMOUNT, round((sum(nvl(s.col_sma0_ln_bal / 10000000, 0) + nvl(s.col_sma1_ln_bal / 10000000, 0) + nvl(s.col_sma2_ln_bal / 10000000, 0) + nvl(s.col_sma3_ln_bal / 10000000, 0))) / (sum(s.col_total_ln_bal) / 10000000) * 100, 2) DUES_PERCENTAGE, sum(s.col_sma0_ln_cnt) SMA0_COUNT, round(sum(s.col_sma0_ln_bal) / 10000000, 2) SMA0_AMOUNT, sum(s.col_sma1_ln_cnt) SMA1_COUNT, round(sum(s.col_sma1_ln_bal) / 10000000, 2) SMA1_AMOUNT, sum(s.col_sma2_ln_cnt) SMA2_COUNT, round(sum(s.col_sma2_ln_bal) / 10000000, 2) SMA2_AMOUNT, sum(s.col_sma3_ln_cnt) SMA3_COUNT, round(sum(s.col_sma3_ln_bal) / 10000000, 2) SMA3_AMOUNT, round((sum(s.col_sma3_ln_bal) / 10000000) / (sum(s.col_total_ln_bal) / 10000000) * 100, 2) NPA_PERCENTAGE, b.reg_id,nvl(sum(s.col_nonnpa_cnt),0) NONNPA_COUNT, nvl(round(sum(s.col_nonnpa_bal) / 10000000, 2),0) NONNPA_BALANCE,round((sum(s.col_sma3_ln_bal) / 10000000) + nvl(sum(s.col_nonnpa_bal) / 10000000,0),2) TOTAL,round((nvl((sum(s.col_sma3_ln_bal) / 10000000),0) + nvl(sum(s.col_nonnpa_bal) / 10000000,0))/(sum(s.col_total_ln_bal) / 10000000) * 100,2) TOTAL_PERCENTAGE from tbl_sma_classification_branch_dtl_his s,branch_dtl_new b,tbl_fzm_master f where s.col_brid=b.BRANCH_ID and b.reg_id=f.region_id and f.fzm_id=" & zone_id & " and to_date(s.col_updt_date)='" & fdt & "' group by b.reg_name,b.reg_id order by b.reg_name"
            dt = oh.ExecuteDataSet(sql).Tables(0)
        ...
        For Each dr In dt.Rows
            ...
            tc71.Text = "<font size=2><a href = javascript:GetAreawiseSMA(" & dr(19) & ",'" & fdt & "','" & tdt & "') > " & dr(0) & "</a></font>" 'zone id
    ...
    Protected Sub btn_excel_Click(sender As Object, e As EventArgs) Handles btn_excel.Click
        ...
        Else
            'sql1 = "select t.col_brid, t.col_brnch_nm, t.col_area_nm, t.col_reg_nm, t.col_zone_nm, t.col_total_ln_cnt, t.col_total_ln_bal, t.col_nodue_ln_cnt, t.col_nodue_ln_bal, t.col_sma0_ln_cnt, t.col_sma0_ln_bal, t.col_sma1_ln_cnt, t.col_sma1_ln_bal, t.col_sma2_ln_cnt, t.col_sma2_ln_bal, t.col_sma3_ln_cnt, t.col_sma3_ln_bal from tbl_sma_classification_branch_dtl_his t, branch_dtl_new b,tbl_fzm_master f where t.col_brid = b.BRANCH_ID and b.reg_id=f.region_id and f.fzm_id = " & zone_id & " and to_date(t.col_updt_date)='" & fdt & "'"
