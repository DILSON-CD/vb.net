<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SMA_Zonewise.aspx.vb" Inherits="Pledge_SMA_classification_SMA_Zonewise" %>
...
<head id="Head1" runat="server">
    <title>Untitled Page</title>
     <script language="javascript" type="text/javascript">
         ...
         function GetRegionwiseSMA(zone_id,fdt,tdt) {
             window.open('SMA_Regwise.aspx?zone_id=' + zone_id + '&fdt=' + fdt + '&tdt=' + tdt + '', '_self');
         }
</script>
</head>
<body>
